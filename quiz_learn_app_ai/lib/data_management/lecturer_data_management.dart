...
class LecturerDataManagement extends StatefulWidget {
  const LecturerDataManagement({super.key});

  @override
  LecturerDataManagementState createState() => LecturerDataManagementState();
}
            ...
            TextButton(
              ...
              onPressed: () async {
                try {
                  ...
                  if (context.mounted) {
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(content: Text('Error updating lecturer: $e')),
                    );
                  }
                }
              },
            ...
            TextButton(
              ...
              onPressed: () async {
                try {
                  ...
                  if (context.mounted) {
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(content: Text('Error deleting lecturer: $e')),
                    );
                  }
                }
              },
